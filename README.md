# Inly
Inly makes it easy to roll your own Crowdsourcing site. To get started, fork this repository and change around ```config/settings.yml``` to suit your needs.

[See it in action](http://Inly.us)

## Background

After a [rejection from Kickstarter](http://techcrunch.com/2012/10/07/the-story-of-lockitron-Crowdsourcing-without-kickstarter/), we decided to follow in the footsteps of [App.net](https://app.net/) and make our own Crowdsourcing site for [Lockitron](https://lockitron.com). We've been absolutely blown away by the response. As a first step in what will hopefully be a long history of giving back, we have decided to open source the Crowdsourcing platform that got us here. Please send questions, comments, or concerns to [hello@lockitron.com](mailto:hello@lockitron.com)!

Inly is a starting point. We made some specific choices with Inly for Lockitron and we recommend you tailor it for your project:
...
* Inly doesn't come with any authentication, administration, mailers or analytics tools. We recommend adding a basic set of these so that you can message backers and manage orders.
...
```bash
git clone https://github.com/lockitron/Inly.git
```
...
In it's current state, Inly is very skeletal. We welcome your pull requests. If you're looking to contribute, here are some good starting points.
...
There is no admin panel with Inly. This could be useful when the project's funding time is over and you want to export your orders elsewhere.
...
Inly is licensed under the [MIT License](https://tldrlegal.com/license/mit-license).
